...
#Initialize total_votes variable (total votes counter)
total_votes = 0
    ...
    #1. Iterate through the candidate list 
        for candidate_name in candidate_votes:
            ...
            vote_percentage = float(votes)/float(total_votes)*100
                #4 Print the candidate name and pe4rcentage of votes 
            
                # To do print out each candidates name, vote, and percentage 
